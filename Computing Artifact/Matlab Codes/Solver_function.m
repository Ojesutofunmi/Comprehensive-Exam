...
function [q,qe,coord] = Solver_function(N,Ne,u,mu,cfl,time_final,integration_points,space_method_type,integration_type)
    ...
    Rmatrix= u*(Dmatrix - Fmatrix) + mu*Lmatrix;
...
%     Mmatrix(npoin,npoin) = 1;
    ...
    %Time Integration
    [q,time] = time_integration(q,Dmatrix_hat,time,Ne,dt,coord,u,mu);
